...
- **Фаза 1.4** — типи даних: гроші зберігаються в `REAL`, дати в `TEXT`.
- **Фаза 1.5** — Postgres DDL + row-level security.
- **Фаза 2** — асинхронний шар доступу (SQLite синхронна, Postgres — ні).
