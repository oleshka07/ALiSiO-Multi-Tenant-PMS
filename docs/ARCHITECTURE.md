...
**Чого ще немає.** Операторський інтерфейс — близько 3 500 рядків — досі
написаний українською просто в JSX. Механізм вибору мови працює, словників для
нього ще нема; поки їх не витягнуто, вибір `de` міняє мову гостьових поверхонь
і напрямок перекладу контенту, але не сам інтерфейс персоналу.
