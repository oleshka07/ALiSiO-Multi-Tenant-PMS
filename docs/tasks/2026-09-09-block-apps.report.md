...
**CI на гілці:** запуск `34451646700` на `3dae4441` (голова після задачі 4 і
злиття гілки робіт) стартував 07:46 UTC і ще біжить; висновок дописується
наступним комітом звіту, щойно запуск завершиться.
