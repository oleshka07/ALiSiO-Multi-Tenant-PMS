...
export const HISTORY_ICONS: Record<string, string> = {
  ...
  guests_change: '👥',
  payment: '💳', note: '📝',
  payment_marker: '📌', payer_change: '🏢', rate_plan_change: '🏷️',
  discount_change: '📉', breakfast_change: '🥐',
...
export const HISTORY_COLORS: Record<string, string> = {
  ...
  payment: 'var(--accent-success)',
  payment_marker: 'var(--text-tertiary)',
  payer_change: 'var(--accent-info)',
  rate_plan_change: 'var(--accent-primary)',
  discount_change: 'var(--accent-warning)',
  breakfast_change: 'var(--text-tertiary)',
  registration_added: 'var(--accent-success)',
  registration_removed: 'var(--accent-danger)',
