    ...
    <>
      <div className="app-content">
        ...
        <PropertyRequired>
          ...
          {/*
            Три межі, названі рецензією 07.09 (правки 4.1, 4.2, 4.5). Кожна —
            це правило, яке готель заведе й побачить його дію в одному місці,
            а в іншому не побачить і не дізнається чому. Поки межі не зняті,
            вони мусять бути на екрані, де правило заводять, а не лише в
            документації.
          */}
          <div className="card" style={{ marginBottom: 12, fontSize: 13, maxWidth: 760, color: 'var(--text-secondary)' }}>
            <strong style={{ color: 'var(--text-primary)' }}>{t('Де правило поки що не діє')}</strong>
            <ul style={{ margin: '6px 0 0', paddingLeft: 18 }}>
              <li>{t('Правило, звужене на тарифи, не діє на власному сайті готелю: форма бронювання працює з тарифами сайту, і звʼязку з тарифами PMS поки немає. У квоті адміністратора й у каналі таке правило діє.')}</li>
              <li>{t('У канал не їдуть правила з умовою про кількість ночей і про період заїзду чи виїзду: канал зберігає ціну на добу, і «1–2 ночі» на ній означало б надбавку на кожну ніч довгого заїзду. Правила за датами проживання й днями тижня їдуть.')}</li>
              <li>{t('Ліміт використань промокоду рахується для онлайн-бронювань. Бронь, заведена адміністратором із промокодом, знижку отримає, але лічильник не збільшить.')}</li>
            </ul>
          </div>
