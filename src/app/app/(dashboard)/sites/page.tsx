            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 12 }}>
              <div style={{ maxWidth: 500 }}>
                ...
                <p style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.65, margin: '0 0 10px' }}>
                  {t('Створіть власний сайт для прямого бронювання короткострокової оренди. Керуйте оголошеннями, тарифними планами та правилами бронювання в одному місці. Виберіть дизайн і приймайте бронювання без посередників — гість платить на місці або за рахунком.')}
                </p>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px 20px' }}>
                  {[
                    t('💳 Платіжний шлюз — обирається в налаштуваннях'),
