    ...
    <div className="page-container" style={{ maxWidth: 1400, margin: '0 auto' }}>
      ...
      <div style={{ marginTop: 24, padding: 16, background: 'var(--bg-secondary)', borderRadius: 10, fontSize: 12, color: 'var(--text-secondary)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 12 }}>
          <SyncRow label="Банк-приймач (KB)" at={data.status.last_sync.bank_inbox} href="/app/finance/settings" />
          <SyncRow label="Receipt inbox (чеки)" at={data.status.last_sync.receipt_inbox} href="/app/finance/receipts" />
          <SyncRow
            label="Teya sync"
