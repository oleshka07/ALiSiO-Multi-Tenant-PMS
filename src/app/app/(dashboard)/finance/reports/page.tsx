...
export default function ReportsLandingPage() {
  ...
  const cards: ReportCard[] = [
    { id: 'cashflow', title: 'Гроші / Cash Flow', desc: 'Рух грошей по категоріях × місяцях', icon: <Wallet size={24} />, href: '/app/finance/reports/cashflow' },
    { id: 'pnl', title: 'P&L', desc: 'Прибутки та збитки з класифікатором', icon: <TrendingUp size={24} />, href: '/app/finance/reports/pnl' },
    { id: 'pnl-2', title: 'PNL-2 (Фінмодель)', desc: 'Звіт за структурою фінмоделі (EBITDA, Margin)', icon: <TrendingUp size={24} />, href: '/app/finance/reports/pnl-2' },
    ...
    { id: 'log', title: 'Історія дій', desc: 'Усі операції в хронологічному порядку', icon: <History size={24} />, href: '/app/finance/operations' },
    { id: 'statement', title: 'Виписка за рахунком', desc: 'Звіт з банківських рахунків з running balance', icon: <FileText size={24} />, href: '/app/finance/reports/statement' },
    { id: 'projects', title: 'Проєкти', desc: 'Прибутковість по проєктах (дохід/витрата/маржа)', icon: <FolderKanban size={24} />, href: '/app/finance/reports/projects' },
    { id: 'balance', title: 'Баланс', desc: 'Активи та пасиви на обрану дату', icon: <Scale size={24} />, href: '/app/finance/reports/balance' },
    { id: 'plan-fact', title: 'План/Факт', desc: 'Порівняння планових і фактичних результатів', icon: <Target size={24} />, href: '/app/finance/reports/plan-fact' },
  ];
