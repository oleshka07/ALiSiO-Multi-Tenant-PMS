...
export interface DayPrice {
  ...
  inherited?: boolean;
  /**
   * Сітка ТАРИФУ: хоч одне обмеження дня — ВЛАСНЕ значення пари (Ц32
   * переглянуто 07.09), а не успадковане від типу. Показане значення — завжди
   * ефективне (пара, інакше тип).
   */
