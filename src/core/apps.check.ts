...
const EXPECTED_KIND: Record<Key, Kind> = {
  ...
  sites: 'module',
  fiscal_de: 'app',
  // Фіскалізація України (19.09.2026, У1): та сама родина, що fiscal_de —
  // розмова з ЧУЖИМ реєстратором, картка на «Застосунках», розділу в меню
  // немає (екран модуля живе в хабі Налаштувань за ключем).
  fiscal_ua: 'app',
  online_payments: 'app',
  // Знімок Winhotel → дзеркало (10.09.2026): розмова з чужою базою, картка на
  // «Застосунках», розділу в меню немає.
  winhotel_import: 'app',
  // Термінал у холі (10.09.2026): розмова з ЗАЛІЗОМ, а не з чужим сервісом, —
