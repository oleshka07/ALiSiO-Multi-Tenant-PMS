...
const amenityNames: ContentDict = {
  ...
  'Чайник/Кавоварка': {
    ...
    cs: 'Konvice/Kávovar',
    pl: 'Czajnik/Ekspres do kawy',
    nl: 'Waterkoker/Koffiemachine',
    fr: 'Bouilloire/Cafetière',
  },
  Кавоварка: {
    en: 'Coffee maker',
    de: 'Kaffeemaschine',
  ...
  'Рушники та білизна': {
    ...
    cs: 'Ručníky a povlečení',
    pl: 'Ręczniki i pościel',
    nl: 'Handdoeken en linnengoed',
  ...
  'Місце для намету': {
    ...
    de: 'Zeltplatz',
    cs: 'Místo pro stan',
    pl: 'Miejsce na namiot',
    nl: 'Tentplaats',
    fr: 'Emplacement tente',
  },
  'Місце для намету/автобудинку': {
    en: 'Tent/RV pitch',
    de: 'Zelt-/Wohnmobilstellplatz',
    cs: 'Místo pro stan/karavan',
    pl: 'Miejsce na namiot/kamper',
    nl: 'Tent/camperplaats',
    fr: 'Emplacement tente/camping-car',
  },
  'Електрика 220V': {
    en: 'Power supply 220V',
    de: 'Stromanschluss 220V',
    cs: 'Elektřina 220V',
    pl: 'Prąd 220V',
    nl: 'Stroom 220V',
    fr: 'Électricité 220V',
...
const faqTranslations: ContentDict = {
  'Як дістатися до комплексу?': {
    en: 'How to get to the complex?',
    de: 'Wie erreicht man die Anlage?',
    cs: 'Jak se dostat do areálu?',
    pl: 'Jak dojechać do kompleksu?',
    nl: 'Hoe bereikt u het complex?',
    fr: 'Comment se rendre au complexe ?',
  },
  'О котрій годині заселення та виселення?': {
    en: 'What are check-in and check-out times?',
    de: 'Um wie viel Uhr ist Ein- und Auschecken?',
    cs: 'V kolik hodin je check-in a check-out?',
    pl: 'O której godzinie jest zameldowanie i wymeldowanie?',
    nl: 'Hoe laat is inchecken en uitchecken?',
    fr: "Quelles sont les heures d'arrivée et de départ ?",
  },
  'Чи можна з тваринами?': {
    en: 'Are pets allowed?',
    de: 'Sind Haustiere erlaubt?',
    cs: 'Jsou povolena zvířata?',
    pl: 'Czy można z zwierzętami?',
  ...
  'Чи є сніданок?': {
    ...
    cs: 'Je součástí snídaně?',
    pl: 'Czy jest śniadanie?',
    nl: 'Is ontbijt inbegrepen?',
    fr: 'Le petit-déjeuner est-il inclus ?',
  },
  'Де магазин?': {
    en: 'Where is the nearest shop?',
    de: 'Wo ist der nächste Laden?',
    cs: 'Kde je nejbližší obchod?',
    pl: 'Gdzie jest sklep?',
    nl: 'Waar is de dichtstbijzijnde winkel?',
    fr: 'Où est le magasin le plus proche ?',
  },
  'Чи є дитяче ліжечко?': {
    en: 'Is a baby crib available?',
    de: 'Gibt es ein Babybett?',
    cs: 'Je k dispozici dětská postýlka?',
    pl: 'Czy jest łóżeczko dla dziecka?',
...
const rulesTranslations: ContentDict = {
  ...
  'Тиша після 22:00': {
    en: 'Quiet hours after 22:00',
    de: 'Ruhezeit ab 22:00',
    cs: 'Klid po 22:00',
    pl: 'Cisza po 22:00',
    nl: 'Stilte na 22:00',
    fr: 'Silence après 22h00',
  },
  'Заборонено палити в приміщеннях': {
    en: 'No smoking indoors',
    de: 'Rauchen im Gebäude verboten',
    cs: 'Zákaz kouření v budově',
    pl: 'Zakaz palenia wewnątrz',
    nl: 'Niet roken binnenshuis',
    fr: "Interdiction de fumer à l'intérieur",
  },
  'Розпалювання вогню лише у відведених місцях': {
    en: 'Fires only in designated areas',
    de: 'Feuer nur an ausgewiesenen Stellen',
    cs: 'Oheň pouze na vyhrazených místech',
    pl: 'Ogień tylko w wyznaczonych miejscach',
    nl: 'Vuur alleen op aangewezen plaatsen',
    fr: 'Feu uniquement aux emplacements désignés',
  },
  'Швидкість по території не більше 10 км/год': {
    en: 'Speed limit 10 km/h on premises',
    de: 'Höchstgeschwindigkeit 10 km/h auf dem Gelände',
    cs: 'Max. rychlost 10 km/h',
    pl: 'Limit prędkości 10 km/h',
    nl: 'Max. snelheid 10 km/u',
    fr: 'Vitesse max. 10 km/h',
  },
  'Сміття — сортуйте та виносьте': {
    en: 'Sort and dispose of waste',
    de: 'Müll sortieren und entsorgen',
    cs: 'Třiďte a vynášejte odpad',
    pl: 'Sortuj i wynoś śmieci',
    nl: 'Afval scheiden en weggooien',
    fr: 'Triez et jetez les déchets',
  },
  'Тварини на повідку, прибирати за ними': {
    en: 'Pets on leash, clean up after them',
    de: 'Tiere an der Leine, bitte aufräumen',
    cs: 'Zvířata na vodítku, uklízejte po nich',
    pl: 'Zwierzęta na smyczy, sprzątaj po nich',
  ...
  'При виїзді поверніть ключі на рецепцію': {
    ...
    cs: 'Při odjezdu vraťte klíče na recepci',
    pl: 'Przy wymeldowaniu oddaj klucze w recepcji',
    nl: 'Retourneer sleutels bij de receptie bij het uitchecken',
    fr: 'Rendez les clés à la réception au départ',
  },
};
...
const usefulInfoTranslations: ContentDict = {
  ...
  'Аптека та лікарня': {
    en: 'Pharmacy & hospital',
    de: 'Apotheke & Krankenhaus',
    cs: 'Lékárna a nemocnice',
    pl: 'Apteka i szpital',
    nl: 'Apotheek & ziekenhuis',
    fr: 'Pharmacie & hôpital',
  },
  'Пішохідні маршрути': {
    en: 'Hiking trails',
    de: 'Wanderwege',
  ...
  'Penny Market та COOP — 5 хв їзди.': {
    en: 'Penny Market and COOP — 5 min drive.',
    de: 'Penny Market und COOP — 5 Min. Fahrt.',
    cs: 'Penny Market a COOP — 5 min jízdy.',
    pl: 'Penny Market i COOP — 5 min jazdy.',
    nl: 'Penny Market en COOP — 5 min rijden.',
    fr: 'Penny Market et COOP — 5 min en voiture.',
  },
  'Аптека в центрі (5 хв). Лікарня — Злін (25 хв).': {
    en: 'Pharmacy in center (5 min). Hospital — Zlín (25 min).',
    de: 'Apotheke im Zentrum (5 Min.). Krankenhaus — Zlín (25 Min.).',
    cs: 'Lékárna v centru (5 min). Nemocnice — Zlín (25 min).',
    pl: 'Apteka w centrum (5 min). Szpital — Zlín (25 min).',
    nl: 'Apotheek in centrum (5 min). Ziekenhuis — Zlín (25 min).',
    fr: 'Pharmacie au centre (5 min). Hôpital — Zlín (25 min).',
  },
  'Маршрути прямо від комплексу. Карти на рецепції.': {
    en: 'Trails right from the complex. Maps at reception.',
    de: 'Wanderwege direkt ab der Anlage. Karten an der Rezeption.',
    cs: 'Trasy přímo od areálu. Mapy na recepci.',
    pl: 'Trasy prosto z kompleksu. Mapy w recepcji.',
    nl: 'Routes direct vanaf het complex. Kaarten bij de receptie.',
    fr: 'Sentiers depuis le complexe. Cartes à la réception.',
  },
  'Велодоріжки вздовж річки. Оренда на рецепції.': {
    en: 'Bike paths along the river. Rental at reception.',
    de: 'Radwege entlang des Flusses. Verleih an der Rezeption.',
    cs: 'Cyklostezky podél řeky. Půjčovna na recepci.',
    pl: 'Ścieżki rowerowe wzdłuż rzeki. Wypożyczalnia w recepcji.',
...
const serviceTranslations: ContentDict = {
  ...
  'Ранній заїзд': {
    ...
    de: 'Früher Check-in',
    cs: 'Dřívější příjezd',
    pl: 'Wczesne zameldowanie',
    nl: 'Vroeg inchecken',
    fr: 'Arrivée anticipée',
  },
  Дрова: {
    en: 'Firewood',
    de: 'Brennholz',
  ...
  'Повноцінний сніданок у ресторані': {
    en: 'Full breakfast in restaurant',
    de: 'Vollständiges Frühstück im Restaurant',
    cs: 'Plná snídaně v restauraci',
  ...
  'Оренда велосипеда на день': {
    ...
    de: 'Fahrradverleih pro Tag',
    cs: 'Pronájem kola na den',
    pl: 'Wynajem roweru na dzień',
    nl: 'Fietsverhuur per dag',
    fr: 'Location de vélo par jour',
  },
  'Оренда електровелосипеда на день': {
    en: 'E-bike rental per day',
    de: 'E-Bike-Verleih pro Tag',
    cs: 'Pronájem elektrokola na den',
    pl: 'Wynajem e-roweru na dzień',
    nl: 'E-fietsverhuur per dag',
    fr: 'Location de vélo électrique par jour',
  },
  'Оренда SUP борду': {
    en: 'SUP board rental',
    de: 'SUP Board Verleih',
    cs: 'Pronájem SUP prkna',
    pl: 'Wynajem deski SUP',
    nl: 'SUP Board verhuur',
    fr: 'Location de planche SUP',
  },
  'Набір для барбекю з вугіллям': {
    en: 'BBQ set with charcoal',
    de: 'Grillset mit Kohle',
    cs: 'Grilovací set s uhlím',
    pl: 'Zestaw grillowy z węglem',
    nl: 'BBQ set met houtskool',
    fr: 'Kit barbecue avec charbon',
  },
  'Закрите паркомісце біля будівлі': {
    en: 'Covered parking near building',
    de: 'Überdachter Parkplatz nahe dem Gebäude',
    cs: 'Kryté parkování u budovy',
    pl: 'Zadaszone miejsce parkingowe przy budynku',
    nl: 'Overdekte parkeerplaats bij het gebouw',
    fr: 'Parking couvert près du bâtiment',
  },
  'за особу/день': {
    en: 'per person/day',
    de: 'pro Person/Tag',
