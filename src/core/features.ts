...
export const FEATURE_SPEC = {
  ...
  //
  // Звідси різні дефолти. Прямі броні ДАЄМО (`ON`) — вони не коштують нам
  // нічого і виграють клієнта. За доступ до чужого трафіку (`channels`) і за
  // конструктор сайту БЕРЕМО.
  booking_engine: { label: 'Форма бронювання на сайті готелю', on: ON },
  site_builder: { label: 'Конструктор сайту-вітрини', on: OFF },
