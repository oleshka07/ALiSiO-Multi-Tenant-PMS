 ...
 * кураторським (`components/layout/nav-items.ts` тримає свій набір із
 * іконками для верхнього меню й нижньої панелі), а пошук бере звідси.
 *
 * ── Права й функції ─────────────────────────────────────────────────────
 *
...
export const DESTINATIONS: Destination[] = [
  ...
  { label: 'Модулі', href: '/app/settings/features', section: 'Налаштування', permission: 'nav:settings', keywords: ['увімкнути', 'вимкнути', 'модулі та інтеграції'] },
  { label: 'Застосунки', href: '/app/settings/apps', section: 'Налаштування', permission: 'nav:settings', keywords: ['інтеграції', 'ключі', 'API', 'fiskaly', 'пошта', 'SMTP', 'стан звʼязку'] },
  ...
  { label: 'Правила цін і промо', href: '/app/settings/price-rules', section: 'Налаштування', permission: 'nav:pricing', keywords: ['знижка', 'промокод', 'промо', 'раннє бронювання', 'останній момент', 'вихідні', 'тривалість', 'правило ціни'] },
