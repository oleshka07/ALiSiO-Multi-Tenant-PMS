...
export type RateLimitedAction = 'service_order' | 'registration' | 'payment_request'
  ...
  | 'guest_lookup'
  // IP: ворота пишуть у базу без жодної сесії — кожна спроба це рядок у
  // `reservations` і ніч, знята з продажу. Без ліміту один скрипт забирає
  // весь готель на тридцять хвилин, і жодна відмова при цьому не лунає.
  | 'guest_hold';
